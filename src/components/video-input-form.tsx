...
export function VideoInputForm(props: VideoInputFormProps) {
    ...
    return (
        <form onSubmit={handleUploadVideo} className="space-y-3">
            <label
                htmlFor="video"
                className="relative border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-secondary/10"
            >
                {
                    previewURL ?
